...
namespace CetBookStore.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Search()
        {
            ...
            ViewData["minfiyat"] = new SelectList(_context.Books, "Price" );
            ViewData["maxfiyat"] = new SelectList(_context.Books, "Price");
            return View();
        }
        [HttpPost]
        public async Task<IActionResult> Search(SearchViewModel searchModel)
        {
            ...
            if(searchModel.minfiyat.HasValue)
            {
                books = books.OrderByDescending(b => b.Price);
                ViewData["minfiyat"] = new SelectList(_context.Books, searchModel.minfiyat);
            }
            else if(searchModel.maxfiyat.HasValue)
            {
                books = books.OrderBy(b => b.Price);
                ViewData["maxfiyat"] = new SelectList(_context.Books, searchModel.maxfiyat);
            }
